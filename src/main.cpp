...
const string strMessageMagic = "Traincoin Signed Message:\n";
...
// Traincoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Traincoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = " Traincoin Genesis ; Unix Timestamp:1476721492";
        CTransaction txNew;
        txNew.nTime = 1476721492;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1476721492;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2658163 : 2658163;
        ...
        assert(block.hashMerkleRoot == uint256("0x4a09ca9a509cd9b094968bb364c419cf5343a771818cea43078a1e3051a6f695"));
...
unsigned char pchMessageStart[4] = { 0x11, 0xc3, 0x12, 0xc2 };
